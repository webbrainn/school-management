...
<div class="container">
    ...
    <form action="{{ route('admission.store') }}" method="POST" enctype="multipart/form-data" class="mt-4">
        ...
        <div class="section-1 row m-0">
            ...
            <!-- <img id="preview" src="https://via.placeholder.com/150" alt="Upload Image" /> -->
            <!-- </div>
            </div> -->
            ...
            <div class="col-md-4 mt-3 d-flex flex-column align-items-center">
                ...
                <div class="upload-box" onclick="document.getElementById('imageUpload').click();"
                    ...
                    <!-- <img id="preview" src="https://placehold.co/150x150" alt="Upload Image"
                              style="width: 100%; height: 100%; object-fit: cover;" /> -->
                         <img id="preview" src="{{ asset('admin/image/gmail.png') }}" alt="Upload Image" />
                </div>

                {{-- File Input --}}
                <input type="file" name="imageUpload" id="imageUpload" accept="image/*" onchange="previewImage(event)" required/>
            ...
            <div class="footer my-4">
                <p class="note">
                    ...
                    <input type="file" name="adhaar_card" class="form-control" value="{{ old('adhaar_card') }}" />
                    @error('adhaar_card')
                <div class="text-danger">{{ $message }}</div>
                @enderror
                </p>
